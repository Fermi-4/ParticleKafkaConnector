...
public class ParticleConnectorConfig extends AbstractConfig {
	...
	public static final String TOPIC_CONFIG_MODE_CONFIG = "particle.connector.topic_mode";
	public static final String TOPIC_CONFIG_MODE_CONFIGURATION = "config";          // use the config option
	public static final String TOPIC_CONFIG_MODE_DEVICE_ID_CONFIG = "device_id";    // use the device id configuration
	public static final String TOPIC_CONFIG_MODE_PRODUCT_ID_CONFIG = "product_id";  // use the configured product id
	public static final String TOPIC_CONFIG_MODE_CORE_ID = "core_id";               // use the core id of the payload (else none)
	public static final String TOPIC_CONFIG_MODE_EVENT_TYPE = "event_type";         // use the payload event type

	public static final String TOPIC_CONFIG_MODE_DOC = "Configure connector topic target.";
	public static final String TOPIC_CONFIG_MODE_DEFAULT = TOPIC_CONFIG_MODE_CONFIGURATION;
	...
	public static ConfigDef conf() {
		return new ConfigDef()
				...
				.define(TOPIC_CONFIG_MODE_CONFIG, Type.STRING, TOPIC_CONFIG_MODE_DEFAULT, OneOfValidator.isOneOfAndNotNull(String.class, TOPIC_CONFIG_MODE_CONFIGURATION, TOPIC_CONFIG_MODE_EVENT_TYPE, TOPIC_CONFIG_MODE_CORE_ID, TOPIC_CONFIG_MODE_DEVICE_ID_CONFIG, TOPIC_CONFIG_MODE_PRODUCT_ID_CONFIG), Importance.HIGH, TOPIC_CONFIG_MODE_DOC)
				...
				.define(HTTP_PROXY_HOST_CONFIG, Type.STRING, null, Importance.LOW, HTTP_PROXY_HOST_CONFIG_DOC)
				.define(HTTP_PROXY_PORT_CONFIG, Type.INT, -1, Importance.LOW, HTTP_PROXY_PORT_CONFIG_DOC)
	...
	public String getTopicMode() {
		return this.getString(TOPIC_CONFIG_MODE_CONFIG);
	}

...
public class AllProductsPartitionerTest {
    ...
    public void testPartitionWithValidAccessToken() throws IOException {
        ...
        when(mockClient.listAllProducts()).thenReturn(productListResponse);
        ...
        for (Map<String, String> partition : partitions) {
            ...
            assertEquals(ParticleConnectorConfig.EVENT_MODE_PRODUCT, partition.get(ParticleConnectorConfig.EVENT_MODE_CONFIG));
        }
    }
    ...
    public void testPartitionWithException() throws IOException {
        ...
        when(mockClient.listAllProducts()).thenThrow(new IOException(fakeExceptionString));

...
public class AllDevicesPartitionerTest {
    ...
    public void testPartitionWithValidAccessToken() throws IOException {
        ...
        String jsonResponse = objectMapper.writeValueAsString(List.of(device1, device2));
        ...
        Response response = new Response.Builder()
                ...
                .build();
        when(mockClient.listDevices()).thenReturn(response);
    ...
    public void testPartitionWithException() throws IOException {
        ...
        when(mockClient.listDevices()).thenThrow(new IOException(fakeExceptionString));

...
import static com.github.fermi4.particle.config.ParticleConnectorConfig.DELIMITER;
...
public class PartitionUtilTest {
	...
	public void testPartitionConfigOnFieldDelimiter() {
		...
		map.put(DEVICE_ID_CONFIG, DEVICE1 + DELIMITER + DEVICE2);
	...
	public void testDistributePartitions() {
		...
		/* partition the config by device id */
		List<ParticleConnectorConfig> partitionedConfigs = PartitionUtil.distributePartitionsAsConfig(originalConfig, DEVICE_ID_CONFIG, DELIMITER, 3);
